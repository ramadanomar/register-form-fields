...
# registerformfields/templates/registerformfields/tasks/
...
for service, template_path in MY_INIT_TASKS:
    full_path: str = str(
        importlib_resources.files("registerformfields")
...
hooks.Filters.ENV_TEMPLATE_ROOTS.add_items(
    ...
    [
        str(importlib_resources.files("registerformfields") / "templates"),
    ]
)
...
hooks.Filters.ENV_TEMPLATE_TARGETS.add_items(
    ...
    # For example, ``registerformfields/templates/registerformfields/build``
    # will be rendered to ``$(tutor config printroot)/env/plugins/registerformfields/build``.
    [
        ("registerformfields/build", "plugins"),
        ("registerformfields/apps", "plugins"),
    ],
)
...
# For each file in registerformfields/patches,
...
#   $ tutor registerformfields example-command
